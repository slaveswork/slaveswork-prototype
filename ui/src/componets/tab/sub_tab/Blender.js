        ...
        <div className="sub_tab_background">
            <div className="sub_tab">
                ...
                <ol>
                    ...
                    <li>In the search box, enter "SlavesWorkBlenderAddOn" to filter the list of add-ons shown</li>
                    <li>Make sure that "Render: test2" has been checked</li>
                    <li>If this is an update: restart the add-on by un-checking it first</li>
                    <li>Back in the main window, you should be able to switch the renderer to Slave's Work Render</li>
                </ol>
            </div>
        </div>
    );
